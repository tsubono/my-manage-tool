    ...
    public function run()
    {
        ...
        DB::table('clients')->insert([
                [
                    ...
                    'icon_path' => 'img/company-icon-1.jpg',
                    'created_at' => $now,
                    'updated_at' => $now,
                ],
                [
                    ...
                    'icon_path' => 'img/company-icon-2.jpg',
                    'created_at' => $now,
                    'updated_at' => $now,
                ],
                [
                    ...
                    'icon_path' => 'img/company-icon-3.jpg',
                    'created_at' => $now,
                    'updated_at' => $now,
                ],
                [
                    ...
                    'icon_path' => 'img/company-icon-4.jpg',
                    'created_at' => $now,
                    'updated_at' => $now,
                ],
                [
                    ...
                    'icon_path' => 'img/company-icon-5.jpg',
                    'created_at' => $now,
                    'updated_at' => $now,
                ],
                [
                    ...
                    'icon_path' => 'img/company-icon-6.jpg',
                    'created_at' => $now,
                    'updated_at' => $now,
                ],
            ]
